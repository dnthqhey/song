(function ($) {
    ...
    $(function () {
        ...
        var $calamityTab = $('.calamity_tab'),
            $tabItem = $calamityTab.find('.tab_item');

        $tabItem.click(function () {
            var $thisIndex = $(this).index();
            $tabItem.removeClass('active').removeAttr('title');
            $(this).addClass('active').attr('title', '활성화');
            $('.calamity_panel .panel_content').removeClass('active').removeAttr('title').eq($thisIndex).addClass('active').attr('title', '활성회');
        });


        var $calamityPanel = $('.calamity_panel'),
            $calamityList = $calamityPanel.find('.item_list'),
            $calamityItem = $calamityList.find('.item'),
            $calamityButton = $calamityItem.find('.list_line'),
            $calamityContent = $calamityItem.find('.list_content');

        $calamityButton.click(function () {
            ...
            if ($item.hasClass('active')){
                ...
                $calamityItem.removeClass('active');
                $calamityItem.removeAttr('title');
                $calamityContent.slideUp();
        ...
        /*$('.calamity_panel .panel_content .item_list .item:first-child .list_line').trigger('click');*/
