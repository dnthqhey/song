(function ($) {
	...
	$(function () {
		...
		$serviceOpen.click(function () {
			...
			$('.service .slick-slide').removeAttr('tabindex');
		});

		/* 서비스 - tabindex 관련 수정 */
		$(document).on('click', '.service .slick-arrow', function() {
			$('.service .slick-slide').removeAttr('tabindex');
			setTimeout("$('.service .slick-slide').removeAttr('tabindex');", 500);
		});
		...
		/* slick tabindex 관련수정 */
		$('#container .slick-slide').each(function(){
			if($(this).children('a').length){
				$(this).removeAttr('tabindex');
			}
		});

		$('#container .slick-slider').each(function(){
