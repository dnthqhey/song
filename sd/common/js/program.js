document.write("<script src='/common/js/spin.js'></script>");
    ...
    Datepicker.prototype = {
        ...
        updateNavArrows: function() {
            if (this._allow_update) {
                ...
                this.picker.find(".prev").toggleClass("disabled", prevIsDisabled).attr("disabled",prevIsDisabled), this.picker.find(".next").toggleClass("disabled", nextIsDisabled).attr("disabled",nextIsDisabled);
            }
        },
        click: function(e) {
