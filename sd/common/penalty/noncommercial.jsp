...
<div id="sub02_1448">
	...
	<div id="sub02_1448_cts">
		...
		<input type="hidden" name="type" value="noncommercial"/>
...
<div class="box_3">
	...
	<div class="text">
		...
		<ul class="num">
			<li class="n01">가입하지 아니한 기간이 10일 이내인 때 : 1만원(대인1), 5천원(대물)</li>
			<li class="n02">가입하지 아니한 기간이 10일을 초과한 때 : 1일당 4천원(대인1), 2천원(대물)</li>
			<li class="n03">최고 60만원(대인1), 최고 30만원(대물)</li>
		</ul>
	</div>
