...
%>
		...
		<div class="sub02_1448_box02" style="margin-bottom:5px">
			의무보험 과태료(대인Ⅱ) 예정액은 <span style="color:BLUE"><%= rangeDay %>일</span> 위반에 <span style="color:RED"><%= resultWon2 %>원</span> 입니다.
		</div>
		<div class="sub02_1448_box02">
			의무보험 과태료(대   물) 예정액은 <span style="color:BLUE"><%= rangeDay %>일</span> 위반에 <span style="color:RED"><%= resultWon3 %>원</span> 입니다.
		</div>
<%
		}
...
<div class="box_3">
	...
	<div class="text">
		...
		<ul class="num">
			<li class="n01">가입하지 아니한 기간이 10일 이내인 때 : 3만원(대인1), 3만원(대인2), 5천원(대물)</li>
			<li class="n02">가입하지 아니한 기간이 10일을 초과한 때 : 1일당 8천원(대인1), 8천원(대인2), 2천원(대물)</li>
			<li class="n03">최고 100만원(대인1), 최고 100만원(대인2), 최고 30만원(대물)</li>
		</ul>
	</div>
