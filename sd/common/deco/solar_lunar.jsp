...
try {
	...
	String s_today = kr.co.hanshinit.NeoCMS.cmm.util.DateUtil.getNowDateTime("yyyyMMdd");
	String l_today = kr.co.hanshinit.NeoCMS.cmm.util.DateUtil.getLunarFromSolar(s_today);
