...
var kakaoMap = 
{
    appKey : 'bbf427e17df2a8240c7ff3eb78e9ced9',    // 지도 앱 키 (현재영등포구 홈페이지 앱키임)
    lat : '37.526364',      // 최초 지도 로딩시 위도 값
    lng : '126.896270',     // 최초 지도 로딩시 경도 값
    mapName : '영등포구청',   // 최초 지도 로딩 위치 이름
    postDefaultName : '서울특별시 영등포구' // 우편번호 주소 검색시 기본 검색 값
};
